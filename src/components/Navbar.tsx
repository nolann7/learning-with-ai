...
const Navbar = async (props: Props) => {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 bg-white dark:bg-gray-950 z-[10] h-fit border-b border-zinc-300 py-2 px-1">
        ...
        <div className="flex items-center">
          ...
          {session?.user && (
            <>
              ...
              <Link href="/create" className="hidden mr-3 sm:block">
                Create Course
              </Link>
